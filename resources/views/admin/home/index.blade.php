                    ...
                    <div class="col-4">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-1">
                                    <a style="color: #e7d63d" href="{{ route('admin.product.index') }}" class="mb-0">
                                        Xem chi tiết </a>
                                </div>
                    ...
                    <div class="col-4">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-1">
                                    <a style="color: #47a8e9" href="{{ route('admin.order.index') }}" class="mb-0">
                                        Xem chi tiết
                                    </a>
                                </div>
                    ...
                    <div class="col-4">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                ...
                                <h3><span class="counter" style="visibility: visible;">{{ $completedOrders }}</span></h3>
                                <div class="d-flex align-items-center justify-content-between mt-1">
                                    <a style="color: #e79933" href="{{ route('admin.order.index') }}" class="mb-0">
                                        Xem chi tiết
                                    </a>
                                </div>
